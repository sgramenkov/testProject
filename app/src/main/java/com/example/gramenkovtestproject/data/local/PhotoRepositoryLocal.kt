...
class PhotoRepositoryLocal : IPhotoRepositoryLocal {
    ...
    override fun getFullSizePhoto(albumId: Int, photoId: Int, completion: DataCompletion<Bitmap>) {
        var bitmap: Bitmap? = null
        realm.executeTransactionAsync({
            val photo =
                it.where(SavedPhoto::class.java).equalTo("albumId", albumId).equalTo("id", photoId)
                    .findFirst()
